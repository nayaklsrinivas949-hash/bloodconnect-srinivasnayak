...
const STORAGE_KEYS = {
  DONORS: 'bloodconnect_donors_hyd_v6',
  HOSPITALS: 'bloodconnect_hospitals_hyd_v6',
  REQUESTS: 'bloodconnect_requests_hyd_v6',
  REWARDS_CATALOG: 'bloodconnect_rewards_catalog_hyd_v6',
  REDEMPTIONS: 'bloodconnect_redemptions_hyd_v6',
  CURRENT_USER: 'bloodconnect_current_user_hyd_v6',
  FITNESS_LOGS: 'bloodconnect_fitness_logs_hyd_v6',
  INVENTORY: 'bloodconnect_inventory_hyd_v6'
};
...
const SEED_HOSPITALS = [
  {
    ...
    lat: 17.4156,
    lon: 78.4116,
    contact: '+91 87121 27285',
    emergencyHelpline: '8712125285',
